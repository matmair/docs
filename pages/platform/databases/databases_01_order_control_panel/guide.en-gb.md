...
Continue with the *Configure your instance to accept incoming connections* guide of your selected database type available [here](https://docs.ovh.com/gb/en/publiccloud/databases/) to configure your service after installation.
